 ...
 %% 训练设置
    ...
    for epoch = 1:num_epochs
        ...
        while hasdata(mbq_train)
            ...
            [train_loss, gradients] = dlfeval(@modelGradients, net, state, control, label, L1, L2, L3, PhiDimensions);
        ...
        if mod(epoch, 5) == 0
            ...
            for i = 7
                ...
                [test_loss(i), ~, ~] = evaluate_lko_mlp(net, control_test, state_test, label_test, PhiDimensions);
            end
